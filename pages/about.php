            ...
            <ul>
              <li>
                <strong>Augustana College|Rock Island,IL</strong>
                  <p>-Bachelor of Science <strong>Computer Science</strong></p>
                  <p><strong>-Graduation Date:</strong> 2028</p>
                  <p><strong>Current GPA</strong>:2.77</p>
              </li>
              <li><strong>Asanteman Senior High|Kumasi,Gh</strong>
          ...
          <h2>Work experience</h2>
                  <ul>
                    ...
                    <li>
                     ...
                     <p>Worked alongside my peers to create and maintain a dining experience that catered to the needs of the students.</p>
                     <p>-Facilities|Grounds(May-Aug 2024)</p>
                     <p>Assisted in maintaining and landscaping the facilities and ensuring that they met the needs of the students and staff.</p>
                    </li>

                    <li>
                      <strong>Personal Assitant|PIE- Kumasi,Gh</strong>
                      <p>-Customer Service(Jan 2023 - Nov 2023)</p>
                    </li>
